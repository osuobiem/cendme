			...
			<div class="col-md-6">
				<div class="card card-static-2 mb-30">
					<div class="card-title-2">
						<h4>Enter Password to Access Settings</h4>
					</div>
					<div class="card-body-table">
						<div class="news-content-right pd-20">
							<form class="row" method="POST" id="password-form">
                @csrf
                <div class="col-lg-12">
									<div class="form-group mb-3">
										<label class="form-label">Password <span class="text-danger">*</span></label>
										<input type="password" class="form-control"
											placeholder="Superadmin Password" required name="password">
								...
								<div class="col-lg-12 text-center">
									<button class="save-btn hover-btn" type="submit">
										<span id="btn-txt">Proceed to {{ ucfirst($page) }} Settings</span>
...
<script>
	...
	$(document).ready(function () {
		...
		$('#password-form').submit(el => {
			...
			let url = "{{ url('settings/load/'.$page) }}"
