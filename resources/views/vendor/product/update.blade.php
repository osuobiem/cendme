  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="justify-content-center" method="POST" id="update{{ $product->id }}-product-form">
          @csrf
          
          <div id="product-content-{{ $product->id }}" class="row justify-content-center">
            <div class="col-lg-3 col-md-5 text-center">
              ...
              <button class="btn btn-outline-secondary mt-2 photo-btn" type="button" id="e{{ $product->id }}-select-img"
          ...
          <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-3 ml-auto mr-auto" style="justify-content: center !important">
            <button class="btn btn-sign hover-btn" type="submit" style="width: auto !important" id="update{{ $product->id }}-product-btn" type="submit" onclick="updateProduct({{ $product->id }})">
